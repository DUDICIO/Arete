...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        maxFileSize: 0,
        messages: {
            'default': 'Upload main image here or directly drag and drop',
        ...
        tpl: {
            ...
            message:     '<div class="dropify-message"><i class="fa fa-fw fa-cloud-upload file-icon"></i> <p>{{ default }}</p></div>',
...
$('.choices__input').blur(function()
                {
                     if( $(this).val().length !== 0 ) {
                     $(".choices__input").addClass("hide").removeClass("choices__input");
                }
            });
